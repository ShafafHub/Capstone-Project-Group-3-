...
export default function Home() {
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      {/* --- HERO SECTION --- */}
      <section className="max-w-[1280px] mx-auto px-6 pb-10 grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div className="grid grid-cols-2 gap-3 sm:gap-5 relative lg:top-20">
          {search.trim() !== "" && filteredHeroProducts.length === 0 ? (
            ...
            filteredHeroProducts.slice(heroIndex, heroIndex + heroItemsPerSlide).map(p => {
              const isOutOfStock = !p.in_stock;
              return (
                <div key={p.id}>
                  {isOutOfStock ? (
                    <div className="group opacity-50 grayscale cursor-not-allowed">
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
              {newProducts.slice(currentIndex, currentIndex + itemsPerPage).map((p) => {
                const isOutOfStock = !p.in_stock;
                return (
                  <div key={p.id}>
                    {isOutOfStock ? (
      ...
      <section className="max-w-[1280px] mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {filtered.slice(page * itemsPerPage, (page + 1) * itemsPerPage).map(p => {
            const isOutOfStock = !p.in_stock;
            return (
              <div key={p.id}>
                {isOutOfStock ? (
      ...
      <section className="py-20 text-center px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-10">
          <img src="/images/Rectangle 16.png" alt="fashion" />
          <img className='mt-6 sm:mt-16' src="/images/Rectangle 14.png" alt="fashion" />
          <img src="/images/Rectangle 12.png" alt="fashion" />
          <img className='mt-6 sm:mt-16' src="/images/Rectangle 15 (1).png" alt="fashion" />
        </div>
